...
(function(){
  ...
  function L(lang){
    ...
    const map = {
      ru: { uiLanguage: 'Язык интерфейса', studyLanguage: 'Язык тренировки', chooseDeck: 'Выберите словарь', ok: 'OK' },
      uk: { uiLanguage: 'Мова інтерфейсу', studyLanguage: 'Мова тренування', chooseDeck: 'Оберіть словник', ok: 'OK' },
      en: { uiLanguage: 'Interface language', studyLanguage: 'Study language', chooseDeck: 'Choose deck', ok: 'OK' }
    };
    return map[l] || map['ru'];
  }
