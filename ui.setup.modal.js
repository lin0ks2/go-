...
(function(){
  ...
  function L(lang){
      ...
      const map={
        ru:{uiLanguage:'Язык интерфейса',studyLanguage:'Язык тренировки',chooseDeck:'Выберите словарь',ok:'OK',setupTitle:'Первичная настройка'},
        uk:{uiLanguage:'Мова інтерфейсу',studyLanguage:'Мова тренування',chooseDeck:'Оберіть словник',ok:'OK',setupTitle:'Початкове налаштування'},
        en:{uiLanguage:'Interface language',studyLanguage:'Study language',chooseDeck:'Choose deck',ok:'OK',setupTitle:'Initial setup'}
      };
      return map[l]||map.ru;
    }
  ...
  function build(){
    ...
    modal.innerHTML = ''
      ...
      +     '<div class="flagsRow" id="setupUiFlags" class="langFlags flagsRow" style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;justify-content:center;margin:8px 6px 10px;"></div>'
      +   '</div>'
      +   '<div class="field">'
      +     '<div class="label">' + (i18n('studyLanguage','Язык тренировки')) + '</div>'
      +     '<div class="flagsRow" id="setupStudyFlags" class="langFlags flagsRow" style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;justify-content:center;margin:8px 6px 10px;"></div>'
      +   '</div>'
      +   '<div class="field">'
